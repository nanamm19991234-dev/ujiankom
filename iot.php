...
define('FIREBASE_DB_URL', 'https://ujikom-iot-2026-89010-default-rtdb.asia-southeast1.firebasedatabase.app');
...
define('FIREBASE_SECRET', '995V64F7x6G4Fh93qV9R9l0P9e6V6R6V9');   // <-- Isi jika menggunakan autentikasi
...
// --- MODE: Baca Relay ---
// Menangkap parameter URL '?relay=N' untuk membaca status relay (N=1..4).
// Blok kode ini dipanggil ESP8266 untuk mengetahui apakah relay harus menyala (1) atau mati (0).
if (isset($_GET['relay'])) {
...
// Menangkap parameter URL '?data=name:value' untuk mengirim nilai sensor ke Firebase.
// ESP8266 mengirimkan format data (misal: suhu:27) yang kemudian diparse dan diteruskan
// ke Realtime Database menggunakan REST API melalui fungsi firebaseRequest().
if (isset($_GET['data'])) {
